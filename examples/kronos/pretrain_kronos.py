...
from megatron_patch.model.kronos.layer_specs import (
    get_gpt_layer_local_spec,
    get_gpt_layer_with_transformer_engine_spec,
)
from megatron_patch.model.kronos.model import GPTModel
from megatron_patch.model.kronos.transformer_config import LLama3TransformerConfig
...
def model_provider(
    ...
    print_rank_0("building kronos model ...")

    config = core_transformer_config_from_args(args, LLama3TransformerConfig)
    use_te = args.transformer_impl == "transformer_engine"

    if use_te:
        print_rank_0("building kronos model in TE...")
        transformer_layer_spec = get_gpt_layer_with_transformer_engine_spec(
            args.num_experts, args.moe_grouped_gemm, args.qk_layernorm
        )
    else:
        print_rank_0("building kronos model in Mcore...")
